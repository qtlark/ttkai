...
function MusicMessage(props: MusicMessageProps) {
    ...
    const content = `<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=200 height=66 src="https://music.163.com/outchain/player?type=2&id=${props.content}&auto=0&height=66"></iframe>`;
